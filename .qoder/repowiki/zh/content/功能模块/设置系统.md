...
## 简介
本文件面向Anchor Learning的设置系统，提供从功能到实现细节的完整说明。重点覆盖以下方面：
...
- 主题与 UI：Anchor Learning 游戏化风格主题与自定义按钮组件

```mermaid
graph TB
subgraph "界面层"
S["设置屏幕<br/>SettingsScreen"]
B["自定义按钮<br/>AnchorButton"]
end
subgraph "提供者层"
...
- [anchor_button.dart:5-103](file://lib/shared/widgets/anchor_button.dart#L5-L103)
...
### 主题与UI（AppTheme、AnchorButton）
- AppTheme：定义浅色主题、颜色体系、字体与组件样式
- AnchorButton：自定义3D凸起按钮，支持禁用态与按下动画
