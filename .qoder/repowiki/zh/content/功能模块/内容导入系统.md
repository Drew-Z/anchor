...
- [android/app/src/main/kotlin/cc/eu/playlab/anchor/MainActivity.kt](file://android/app/src/main/kotlin/cc/eu/playlab/anchor/MainActivity.kt)
...
## 简介
本系统为“Anchor Learning”应用的内容导入与智能拆题能力提供端到端解决方案。其核心目标是：
...
- [android/app/src/main/kotlin/cc/eu/playlab/anchor/MainActivity.kt:1-6](file://android/app/src/main/kotlin/cc/eu/playlab/anchor/MainActivity.kt#L1-L6)
...
## 结论
Anchor Learning的内容导入系统通过Android系统分享机制与Flutter应用的无缝衔接，实现了从外部内容到结构化题目的自动化拆解与持久化。系统以Riverpod为核心组织状态与依赖，结合SQLite完成可靠的数据存储，并通过OpenAI API实现高质量的智能拆题。整体流程清晰、容错完备，能够在多样化的分享场景下保持稳定与易用。
