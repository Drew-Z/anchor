...
## 简介
本系统是一个基于 Flutter 的题库管理系统，围绕“题包（Deck）”与“题目（Question）”两大核心实体构建，支持从文本/图片内容中由 AI 自动生成题目，形成题包并进行学习与复习。系统采用 Riverpod 状态管理、SQLite 数据持久化，界面遵循 Anchor Learning 游戏化风格主题设计。
