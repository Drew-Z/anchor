...
## 简介
本文件系统性梳理 Anchor Learning 项目中的依赖注入机制，基于 Riverpod 实现的服务注册与解析。文档覆盖以下要点：
...
## 项目结构
Anchor Learning 采用功能模块化组织，依赖注入集中在 core/providers/providers.dart，服务层位于 services/，数据访问位于 data/database/，UI 层位于 features/。
...
## 架构总览
Anchor Learning 的依赖注入采用“Provider 工厂 + 构造函数注入”的组合模式：
...
## 结论
Anchor Learning 通过 Riverpod 实现了清晰、可维护的依赖注入体系：
