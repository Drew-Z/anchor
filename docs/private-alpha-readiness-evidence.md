...
owner, release-day, or cohort evidence, and initializes the external gates as false.
...
true. Filled optional cohort and operations records remain outside the
repository; the readiness file stores only approved anonymous codes and opaque
locators.
...
fingerprints, freshness, physical-device semantics, and cross-evidence
consistency. Optional cohort records are not part of technical readiness.
