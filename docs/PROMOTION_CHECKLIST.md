...
> 基于 docs-to-book 理念优化的推广计划。推广素材不是 Private Alpha readiness 门禁，
> 当前真实状态请查看 `docs/OPEN_SOURCE_CHECKLIST.md`。
...
□ 答题后的解析页面 (展示来源溯源链接)
□ 知识点列表 (展示学习进度)
□ 设置页面 (展示应用内 AI profile 配置；不得展示真实 API Key)
```
...
□ 发布到项目主页 (https://anchor.playlab.eu.cc)
...
**维护者**: bill
**最后更新**: 2026-08-24
**下次检查**: 推广素材准备完成后更新；不改变 readiness 的 `HOLD/GO` 决策
