...
const translations = {
  en: {
    ...
    'nav.demo': 'Demo',
    'nav.source': 'Source',
    'hero.eyebrow': 'Traceable learning workspace',
    'hero.lead': 'Turn documentation and code into source-grounded practice. Every explanation stays connected to the exact passage that supports it.',
    'hero.note': 'The web demo uses bundled sample data and makes no AI requests.',
  ...
  zh: {
    ...
    'nav.demo': '演示',
    'nav.source': '源码',
    'hero.eyebrow': '来源可溯源的学习工作台',
    'hero.lead': '把技术文档和代码转化为基于原文的练习，让每段解释都能回到真正支持它的具体位置。',
    'hero.note': 'Web 演示只使用内置样例数据，不会发起 AI 请求。',
