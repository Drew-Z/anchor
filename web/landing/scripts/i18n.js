...
const translations = {
  en: {
    ...
    'actions.downloadApk': 'Download Android APK',
    ...
    'native.disclosure': 'Captured on a physical Android device from the current Private Alpha. Download the signed Arm64 APK from the GitHub release.',
    ...
    'demo.pointThree': 'No account, upload, backend, or AI call; Cloudflare Web Analytics measures page performance',
  ...
  zh: {
    ...
    'actions.downloadApk': '下载 Android APK',
    ...
    'native.disclosure': '画面来自当前 Private Alpha 的真实 Android 设备；签名 Arm64 APK 可从 GitHub Release 下载。',
    ...
    'demo.pointThree': '无需账号、上传、后端或 AI 调用；Cloudflare Web Analytics 仅测量页面性能',
